...
class C3_Biformer(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, win=64, shortcut=True, g=1,
...
class CSCBiF(nn.Module):
    def __init__(self, c1, c2, n=1, win=64, shortcut=True, k=(1, 1), g=1,
                 e=0.5):  # ch_in, ch_out, number, shortcut, groups, expansion
...
class ReNBC(nn.Module):
    def __init__(self, c1, c2, n=1, win=8, isUse=False, shortcut=True, g=1,
                 e=0.5):  # ch_in, ch_out, number, shortcut, groups, expansion
        super().__init__()
