...
def plot_pr_curve(px, py, ap, save_dir=Path("pr_curve.png"), names=(), on_plot=None):
    ...
    ax.set_xlim(0, 1)
    ax.set_ylim(0, 1)
    ax.legend(bbox_to_anchor=(1.04, 1), loc="upper left",fontsize=13)
    ax.tick_params(axis='both', which='major', labelsize=15)  # ✅ 刻度数字字体大小
    ax.set_title("Precision-Recall Curve",fontsize=23)
